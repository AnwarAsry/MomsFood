            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 lg:gap-8">
                    <section className="flex items-center justify-end gap-2 lg:col-span-2">
                        <button className="w-fit px-6 py-2 flex items-center gap-1.5 border border-black/30 rounded-md font-medium text-[#4b5563] hover:bg-gray-100 transition-colors cursor-pointer" onClick={() => navigate(-1)}>
                            Cancel
                        </button>
                        <button className="w-fit px-8 py-2 flex items-center rounded-md font-medium text-white bg-[#374151] hover:bg-[#4b5563] transition-colors cursor-pointer" type="submit">
